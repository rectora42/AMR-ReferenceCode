...
\end{small}
# Acknowledgements  
This CV was created using R version 4.2.1 with RStudio and adapted style documents from the R package *vitae*. Associated code can be found in my github repository, [AMR-CV]().